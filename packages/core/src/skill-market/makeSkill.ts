...
const SKILL_MD = [
  ...
  "",
  "## 4. Ask the user once",
  "Show the drafted name + description + a one-line pitch. Explain the economics plainly:",
  "publishing mints the skill PRICED at 0.1 SOL — others pay that to use it and the user (the",
  "creator) earns it; the mint itself costs only a small on-chain fee, not 0.1 SOL. Ask once",
  "whether to publish. If they say no, or do not clearly say yes, stop — do not publish.",
  "",
  "## 5. Publish",
  "On their explicit yes, call `publish_skill` with the draft (name, description, skillText,",
  "and a category / hashtags if useful). Keep it priced at 0.1 SOL — pass priceSol \"0.1\" (the",
  "default) so the user earns when others use it; pass \"0\" (free) only if the user explicitly",
  "wants it to spread for free. It routes through an approval card and mints the skill.",
  "",
  "## Must not",
