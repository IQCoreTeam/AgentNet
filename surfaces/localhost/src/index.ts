      ...
      case "publishSkill": {
        try {
          const r = await mkt.publishSkill(
            { name: m.name, description: m.description, text: m.text, category: m.category, hashtags: m.hashtags, priceSol: m.priceSol, image: m.image, kind: m.kind, requiredSkills: m.requiredSkills },
